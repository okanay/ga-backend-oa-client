...
export const ContactLabel: ContactLabelProps = ({
  ...
  return (
    <label
      {...props}
      className={twMerge(
        `pointer-events-none absolute left-0 ml-1 -translate-y-3.5 bg-flower-50 px-1 text-xs text-ebony-950 
        transition-all duration-200 ease-linear 
        peer-placeholder-shown:translate-y-2 peer-placeholder-shown:text-sm peer-placeholder-shown:text-ebony-950 
        peer-focus:-translate-y-3.5 peer-focus:text-xs peer-focus:text-ebony-950/50 
