export const PriceHeader = () => {
  return (
    <div className="flex w-full flex-col items-center justify-center text-center">
      ...
      <h4 className="font-plex-serif mb-6 text-balance text-center text-3xl text-secondary-950 base-phone:text-4xl sm:mb-12 sm:text-6xl sm:leading-[3.75rem] lg:max-w-[42.5rem] lg:text-7xl lg:leading-[4.75rem]">
