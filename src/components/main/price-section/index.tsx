...
export const PriceSection = () => {
  ...
  return (
    <section ref={sectionRef} className={"relative h-full bg-flower-50"}>
      <div className={"h-full"}>
        <div className="relative h-full w-full">
          {/*About Price */}
          <div className="flex h-full w-full flex-col items-center justify-center gap-8 px-4 sm:absolute sm:left-0 sm:top-0 sm:min-h-[60svh] sm:pb-0 sm:pt-40">
            ...
            <h5 className="text-balance text-center text-sm tracking-wider text-secondary-800 sm:text-xl sm:leading-[1.4rem] lg:max-w-[880px] lg:text-2xl lg:leading-[1.85rem]">
              With our one-time payment plan, you can save money and time on
              your website's indexation. Get started today and see the
              difference!
            </h5>
